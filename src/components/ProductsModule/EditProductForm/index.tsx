...
const EditProductForm = (productDetails: IProduct) => {
  ...
  useEffect(() => {
    form.reset(JSON.parse(JSON.stringify(productDetails)));
  }, [productDetails]);
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-2">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Select Category {field.value}</FormLabel>
                      <Select
                        onValueChange={field.onChange}
                        // value={field.value}
                        // defaultValue={field.value}
                        defaultValue={String(productDetails.category)}
                      >
                        <FormControl>
                          <SelectTrigger>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value={ProductCategory.SHIRT}>
                            Shirt
                          </SelectItem>
                        </SelectContent>
                      </Select>
